...
async function main() {
  ...
  try {
    ...
    while (await cursor.hasNext()) {
      ...
      if (!eligibility.ok) {
        console.log("Skipped:", donation._id.toString(), "reason:", eligibility.reason);
        skipped++;
        continue;
      }
      ...
      if (!contact) {
        console.log("Skipped:", donation._id.toString(), "reason: contact not found");
        skipped++;
        continue;
      }
      ...
      if (!phone) {
        console.log("Skipped:", donation._id.toString(), "reason: no phone");
        skipped++;
        continue;
      }
      ...
      if (!userid) {
        console.log("Skipped:", donation._id.toString(), "reason: no salesforceID");
        skipped++;
        continue;
      }
      ...
      if (DRY_RUN) {
        ...
        twilioSid = msg.sid;
        console.log("Sent:", msg.sid, "to:", phone);
